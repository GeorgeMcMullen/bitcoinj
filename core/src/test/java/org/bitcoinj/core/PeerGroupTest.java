...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        for (ECKey key1 : keys) {
            ...
            Block next = FakeTxBuilder.makeSolvedTestBlock(prev, FakeTxBuilder.createFakeTx(params, params.getGenesisBlockValue(), addr));
        ...
        assertEquals(params.getGenesisBlockValue().multiply(3), wallet.getBalance());

...
public class WalletProtobufSerializerTest {
    ...
    public void oneTx() throws Exception {
        ...
        t1.getConfidence().markBroadcastBy(new PeerAddress(InetAddress.getByName("1.2.3.4"), params));
        t1.getConfidence().markBroadcastBy(new PeerAddress(InetAddress.getByName("5.6.7.8"), params));
    ...
    public void coinbaseTxns() throws Exception {
        ...
        Block b = params.getGenesisBlock().createNextBlockWithCoinbase(myKey.getPubKey(), params.getGenesisBlockValue());
